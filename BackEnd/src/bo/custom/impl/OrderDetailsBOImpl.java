...
public class OrderDetailsBOImpl implements OrderDetailsBO {
    orderDetailsDAOImpl detailsDAO = (orderDetailsDAOImpl) DAOFactory.getDaoFactory().getDAO(DAOFactory.DAOTypes.ORDERDETAILS);
    @Override
    public boolean addOrderDetails(ArrayList<OrderDetailsDTO> cart, Connection connection)throws SQLException, ClassNotFoundException{
        ...
        return detailsDAO.add(orderDetails,connection);
    }
